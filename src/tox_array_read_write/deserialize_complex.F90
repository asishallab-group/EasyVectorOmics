...
subroutine deserialize_complex_r(flat_arr, arr_size, filename_ascii, fn_len, ierr)
...
subroutine deserialize_complex_C(arr, arr_size, filename_ascii, fn_len, ierr) bind(C, name="deserialize_complex_C")
