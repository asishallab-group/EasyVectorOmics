...
!> C binding for extracting all files from a zip archive
subroutine extract_zip_archive_generic_c(zip_filename, filename_len, ierr) bind(C, name="extract_zip_archive_generic_c")
    use iso_c_binding, only: c_char, c_int
    use iso_fortran_env, only: int32
    use tox_conversions, only: c_char_1d_as_string
