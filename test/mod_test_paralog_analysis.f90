...
contains
    ...
    !> Test the take_active_mask_helper function with various configurations of active masks, results, and new active masks.
    ...
    !> Test the add_to_results_helper function with various configurations of results, active masks, and new active masks.
    ...
    !> Test the add_new_active_mask_helper function with various configurations of active masks, results, and new active masks.
