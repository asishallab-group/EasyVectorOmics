...
contains
    ...
    subroutine test_compute_all_contributions()
        ...
        integer(int32) :: factor_indices(n_selected_factors)
        integer(int32) :: dependent_indices(n_selected_dependents)
        real(real64) :: local_contributions(n_timepoints, n_selected_factors, n_selected_dependents, n_samples)
        real(real64) :: total_contributions(n_selected_factors, n_selected_dependents, n_samples)
        ...
        factor_indices = [1]       ! select factor 1
        dependent_indices = [2]    ! select dependent 2
        ...
        call assert_equal_int(ierr, ERR_OK, "test_compute_all_contributions: Case 1 ierr")
        ...
        call assert_equal_array_real(local_contributions(:,1,1,1), expected_local, n_timepoints, TOL, "test_compute_all_contributions: Case 1 local contributions")
        call assert_equal_real(total_contributions(1,1,1), expected_total, TOL, "test_compute_all_contributions: Case 1 total contribution")
