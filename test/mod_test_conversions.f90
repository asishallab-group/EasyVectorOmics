...
contains
    ...
    function get_all_tests() result(all_tests)
     ...
     !> Run all conversions tests.
    subroutine run_all_tests_conversions()
        type(test_case) :: all_tests(8)
        integer(int32) :: i
        ...
        print *, "All conversions tests passed successfully."
    end subroutine run_all_tests_conversions

    !> Run specific conversions tests by name.
    subroutine run_named_tests_conversions(test_names)
    ...
    end subroutine run_named_tests_conversions
