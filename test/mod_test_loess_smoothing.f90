...
contains
  ...
  subroutine test_loess_constant_input()
    ...
    call loess_smooth_2d(n, n/2, x_ref, y_ref, indices_used, n, x_query, 1.0_real64, 3.0_real64, y_out)
  ...
  subroutine test_loess_outlier_suppression()
    ...
    x_query = 10.0_real64
    indices_used = [(i, i = 1, n)]
    call loess_smooth_2d(n, 50, x_ref, y_ref, indices_used, n, x_query, 1.0_real64, 3.0_real64, y_out)
  ...
  subroutine test_loess_single_point()
    ...
    call loess_smooth_2d(1, 1, x1, y1, (/1/), 1, xq1, 0.1_real64, 1.0_real64, yout1)
  ...
  subroutine test_loess_identical_points()
    ...
    call loess_smooth_2d(2, 1, x2, y2, idx2, 2, xq2, 0.1_real64, 1.0_real64, yout2)
  ...
  subroutine test_loess_linear_interp()
    ...
    call loess_smooth_2d(2, 1, x3, y3, idx3, 2, xq3, 0.5_real64, 3.0_real64, yout3)
  ...
  subroutine test_loess_weight_decay()
    ...
    call loess_smooth_2d(2, 1, x2, y2, idx2, 2, xq2, 1.0_real64, 3.0_real64, yout2)
  ...
  subroutine test_loess_mask_exclusion()
    ...
    call loess_smooth_2d(3, 1, x3, y3, indices_used, 1, xq3, 10.0_real64, 3.0_real64, yout3)
  ...
  subroutine test_loess_edge_query()
    ...
    idx = (/1,2,3,4,5/)
    xq = (/0.0, 6.0/)
    call loess_smooth_2d(5, 2, x, y, idx, 5, xq, 1.0_real64, 3.0_real64, yout)
