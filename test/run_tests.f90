program main
  ...
  use mod_test_jensen_shannon
  use mod_test_jensen_shannon_divergence
...
contains
  ...
  call add_suite("edf", run_all_tests_edf, run_named_tests_edf)
    ...
    call add_suite("tox_jensen_shannon", run_all_tests_jensen_shannon, run_named_tests_jensen_shannon)
    call add_suite("tox_jensen_shannon_divergence", run_all_tests_tox_jensen_shannon_divergence, run_named_tests_tox_jensen_shannon_divergence)
