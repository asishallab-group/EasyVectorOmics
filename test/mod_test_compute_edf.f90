...
contains
  ...
  function get_all_tests() result(all_tests)
    ...
    all_tests(1) = test_case("test_compute_edf_simple", test_compute_edf_simple)
    all_tests(2) = test_case("test_compute_edf_all_unique", test_compute_edf_all_unique)
    all_tests(3) = test_case("test_compute_edf_all_same", test_compute_edf_all_same)
    all_tests(4) = test_case("test_compute_edf_duplicates", test_compute_edf_duplicates)
    all_tests(5) = test_case("test_compute_edf_single_value", test_compute_edf_single_value)
  ...
  !> Run all EDF tests.
  subroutine run_all_tests_compute_edf()
  type(test_case) :: all_tests(10)
  integer(int32) :: i
  ...
  end subroutine run_all_tests_compute_edf

  !> Run specific EDF tests by name.
  subroutine run_named_tests_compute_edf(test_names)
  ...
  end subroutine run_named_tests_compute_edf



  !> Test EDF computation with a simple dataset.
  subroutine test_compute_edf_simple()
  ...
  integer(int32) :: ierr, n_unique
   ...
   call compute_edf_alloc(values, n_values, unique_values, cdf_values, n_unique, ierr) 
    ...
    call assert_equal_array_real(cdf_values(1:3), expected_cdf, 3, &
                                  1d-12, "test_compute_edf_simple: CDF values mismatch")
  end subroutine

  !> Test EDF with all unique values.
  subroutine test_compute_edf_all_unique()
  ...
  integer(int32) :: ierr, i, n_unique
   ...
   call compute_edf_alloc(values, n_values, unique_values, cdf_values, n_unique, ierr) 
    ...
    call assert_equal_array_real(cdf_values(1:3), expected_cdf, 3, &
                                  1d-12, "test_compute_edf_all_unique: CDF values mismatch")
  end subroutine
 
  !> Test EDF with all identical values.
  subroutine test_compute_edf_all_same()
  ...
  subroutine test_compute_edf_duplicates()
  ...
  subroutine test_compute_edf_single_value()
  ...
  subroutine test_compute_edf_empty_input()
  ...
  subroutine test_compute_edf_large_dataset()
  ...
  call compute_edf_alloc(values, n, unique_values, cdf_values, n_unique, ierr)
    ...
    call assert_equal_real(unique_values(1), 1.0_real64, 1d-12, &
                           "test_compute_edf_large_dataset: first unique value should be 1.0")
    call assert_equal_real(unique_values(50), 50.0_real64, 1d-12, &
                           "test_compute_edf_large_dataset: last unique value should be 50.0")
  end subroutine

  !> Test EDF with negative values and zero.
  subroutine test_compute_edf_negative_values()
  ...
  subroutine test_compute_edf_with_perm()
    real(real64) :: values(5) = [3.0_real64, 1.0_real64, 2.0_real64, 1.0_real64, 2.0_real64]
    integer(int32) :: n_values = 5
  ...
  call compute_edf(values, n_values, perm, unique_values, cdf_values, n_unique, ierr)
    ...
    call assert_equal_array_real(cdf_values(1:3), expected_cdf, 3, &
                                  1d-12, "test_compute_edf_with_perm: CDF values mismatch")
  end subroutine test_compute_edf_with_perm

end module mod_test_compute_edf
